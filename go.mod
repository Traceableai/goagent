...
replace github.com/Traceableai/goagent/hypertrace/goagent => ./hypertrace/goagent

require (
	github.com/Traceableai/agent-config/gen/go v0.0.0-20250721171230-e7b2fd484619
	github.com/Traceableai/goagent/hypertrace/goagent v0.0.0-00010101000000-000000000000
	github.com/gin-gonic/gin v1.10.0
	github.com/gorilla/mux v1.8.0
	github.com/hypertrace/agent-config/gen/go v0.0.0-20250829142101-d829e6298c17
