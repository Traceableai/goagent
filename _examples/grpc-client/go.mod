module github.com/Traceableai/goagent/_examples/grpc-client
...
require (
	github.com/Traceableai/agent-config/gen/go v0.0.0-20251113174539-eddbccd486a1 // indirect
	...
	github.com/hypertrace/agent-config/gen/go v0.0.0-20251010163100-9bd6b60cc7b8 // indirect
